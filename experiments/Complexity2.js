...
let densityMap = [];
const densityMapSize = 50; // Adjust this value based on how fine-grained you want the density tracking to be
const maxDensity = 20; // Maximum density value for color interpolation
